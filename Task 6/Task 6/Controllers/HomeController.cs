    ...
    public class HomeController : Controller
    {
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                using (SqlDataReader reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        {
                            XelshekrulebaID = reader.GetInt32(0), // integer
                            ...
                            //Shesruleba = reader.IsDBNull(12) ? false : reader.GetBoolean(12),
                            VisiMizezit = reader.IsDBNull(13) ? string.Empty : reader.GetString(13), 
        ...
        public IActionResult ExportToExcel()
        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                worksheet.Cells[1, 6].Value = "დარჩენილი გადასაგდელი (USD)";
                ...
                foreach (var order in orders)
                {
                    ...
                    worksheet.Cells[row, 7].Value = order.Reason;
